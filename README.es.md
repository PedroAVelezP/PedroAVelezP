...
Me especializo en el desarrollo de soluciones de **IA Generativa** aplicadas. Tengo experiencia avanzada en la orquestación de modelos de lenguaje, implementación de memorias vectoriales para sistemas RAG y optimización de flujos de trabajo con **Gemini**.
